...
////////////////////////////////////////////////////////////////////////////////
   ...
   //RooGenericPdf polexp_bkgPDF("polexp_bkgPDF","", "TMath::Exp(@1)", RooArgList(dilep_mass,bkg_polexp_x0) );
//   RooGenericPdf polexp_bkgPDF("polexp_bkgPDF","", "TMath::Exp(@1)+TMath::Exp(@0*@2)+TMath::Exp(@0*@0*@3)+TMath::Exp(@0*@0*@0*@4)", RooArgList(dilep_mass,bkg_polexp_x0,bkg_polexp_x1,bkg_polexp_x2,bkg_polexp_x3) );
//   RooGenericPdf polexp_bkgPDF("polexp_bkgPDF","", "TMath::Exp(@1)+TMath::Exp(@0*@2)+TMath::Exp(@0*@0*@3)", RooArgList(dilep_mass,bkg_polexp_x0,bkg_polexp_x1,bkg_polexp_x2) );
   polexp_bkgPDF1.Print();
   polexp_bkgPDF2.Print();
   ...
   if (altfit_bkg && altfit_bkg_exp)
      polexp_result = polexp_ebkgPDF.fitTo(*datasetHist,RooFit::Extended(1),RooFit::Save(),RooFit::PrintLevel(-1),RooFit::Range("left,right"));

    ////////////////////////////// correct for the SR ////////////////////////
   // TH1F * hyield_sr = new TH1F("hyield_sr","",1,70,110);
//    data_tree->Draw(dilep_var_name+">>hyield_sr",dilep_var_name+">88 && "+dilep_var_name+"<94 && "+cuts);
  //  double ntotal = data_tree->GetEntries();
   // double yield_sr = hyield_sr->Integral();


/*    cheb3_n_bkg.setVal( cheb3_n_bkg.getVal()*(1+yield_sr/ntotal));
    cheb4_n_bkg.setVal( cheb4_n_bkg.getVal()*(1+yield_sr/ntotal));
    cheb5_n_bkg.setVal( cheb5_n_bkg.getVal()*(1+yield_sr/ntotal));
    gamma_n_bkg.setVal( gamma_n_bkg.getVal()*(1+yield_sr/ntotal));
    polexp_n_bkg.setVal( polexp_n_bkg.getVal()*(1+yield_sr/ntotal));
*/
   /////////////////////////////// plotting /////////////////////////////////  
   ...
   if (create_dc_input){
      ...
      //RooGenericPdf polexp_bkgPDF_out("polexp_bkgPDF_"+varname,"", "TMath::Exp(@1)+TMath::Exp(@0*@2)+TMath::Exp(@0*@0*@3)+TMath::Exp(@0*@0*@0*@4)", RooArgList(dilep_mass_out,bkg_polexp_x0,bkg_polexp_x1,bkg_polexp_x2,bkg_polexp_x3) );
