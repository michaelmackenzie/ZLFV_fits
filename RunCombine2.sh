...
if  [[ "${PROCESS}" == "scan" ]]
then
   combine -M MultiDimFit param_datacard_${NAME}.root -m 91 $FROZENPARAM -n .scan_r0_${NAME} --algo grid --points 200  --rMin -5 --rMax 5 --saveNLL --saveWorkspace --cminDefaultMinimizerStrategy 0 --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --robustFit 1 --X-rtd MINIMIZER_multiMin_maskChannels=2
# work data:  --algo grid --points 200  --rMin -5 --rMax 5 --saveNLL --saveWorkspace --saveSpecifiedIndex pdfindex_bin1,pdfindex_bin2,pdfindex_bin3 --trackParameters shapeBkg_bkg_bin1__norm,shapeBkg_bkg_bin2__norm,shapeBkg_bkg_bin3__norm --cminDefaultMinimizerStrategy 0 --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --robustFit 1 --X-rtd MINIMIZER_multiMin_maskChannels=2 --setParameterRanges shapeBkg_bkg_bin1__norm=24000,25800:shapeBkg_bkg_bin2__norm=25200,27200:shapeBkg_bkg_bin3__norm=6400,7200
# work mc: --algo grid --points 200  --rMin -5 --rMax 5 --saveNLL --cminDefaultMinimizerStrategy 0 --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --saveWorkspace --saveSpecifiedIndex pdfindex_bin1,pdfindex_bin2,pdfindex_bin3 --trackParameters shapeBkg_bkg_bin1__norm,shapeBkg_bkg_bin2__norm,shapeBkg_bkg_bin3__norm -t -1 --expectSignal 0 --setParameterRanges shapeBkg_bkg_bin1__norm=24579,24987:shapeBkg_bkg_bin2__norm=26040,26790:shapeBkg_bkg_bin3__norm=6744,7004

# impacts:  --cminDefaultMinimizerStrategy 0 --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --robustFit 1 --X-rtd MINIMIZER_skipDiscreteIterations --X-rtd MINIMIZER_skipDiscreteIterations --X-rtd MINIMIZER_multiMin_maskChannels=2
# data --setParameterRanges shapeBkg_bkg_bin1__norm=24000,25800:shapeBkg_bkg_bin2__norm=25200,27200:shapeBkg_bkg_bin3__norm=6400,7200


### mc --setParameterRanges shapeBkg_bkg_bin1__norm=24579,24987:shapeBkg_bkg_bin2__norm=26040,26790:shapeBkg_bkg_bin3__norm=6744,7004
   plot1DScan.py higgsCombine.scan_r0_${NAME}.MultiDimFit.mH91.root -o ${NAME}_scan_r
   echo "${NAME}_scan_r has been created"
   mv ${NAME}_scan_r.png $ORGDIR
   #plot1DScan.py higgsCombine.scan_r0_${NAME}.MultiDimFit.mH91.root -o ${NAME}_scan_bin1norm --POI trackedParam_shapeBkg_bkg_bin1__norm
   #echo "${NAME}_scan_bin1norm has been created"
   #mv ${NAME}_scan_bin1norm.png $ORGDIR
   #plot1DScan.py higgsCombine.scan_r0_${NAME}.MultiDimFit.mH91.root -o ${NAME}_scan_bin2norm --POI trackedParam_shapeBkg_bkg_bin2__norm
   #echo "${NAME}_scan_bin2norm has been created"
   #mv ${NAME}_scan_bin2norm.png $ORGDIR
   #plot1DScan.py higgsCombine.scan_r0_${NAME}.MultiDimFit.mH91.root -o ${NAME}_scan_bin3norm --POI trackedParam_shapeBkg_bkg_bin3__norm
   #echo "${NAME}_scan_bin3norm has been created"
   #mv ${NAME}_scan_bin3norm.png $ORGDIR
...
if  [[ "${PROCESS}" == "impacts" ]]
then
   EXTRA_OPT=" --cminDefaultMinimizerStrategy 0 --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --robustFit 1 --X-rtd MINIMIZER_skipDiscreteIterations --X-rtd MINIMIZER_skipDiscreteIterations --X-rtd MINIMIZER_multiMin_maskChannels=2 --setParameters shapeBkg_bkg_bin1__norm=24980,shapeBkg_bkg_bin2__norm=26270,shapeBkg_bkg_bin3__norm=6810 --setParameterRanges shapeBkg_bkg_bin1__norm=24000,25800:shapeBkg_bkg_bin2__norm=25200,27200:shapeBkg_bkg_bin3__norm=6400,7200 "
   ...
   #--X-rtd MINIMIZER_multiMin_maskChannels=1 or --X-rtd MINIMIZER_multiMin_maskChannels=2
   # --setParameterRanges shapeBkg_bkg_bin1__norm=24000,25500:shapeBkg_bkg_bin2__norm=22000,30000
   # --rMin -10 --rMax 10
   # --setParameters shapeBkg_bkg_bin1__norm=24772,shapeBkg_bkg_bin2__norm=26393,shapeBkg_bkg_bin3__norm=6863
  ### worked " --cminDefaultMinimizerStrategy 0 --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --robustFit 1 --X-rtd MINIMIZER_skipDiscreteIterations --X-rtd MINIMIZER_skipDiscreteIterations --X-rtd MINIMIZER_multiMin_maskChannels=2 --setParameters shapeBkg_bkg_bin1__norm=24980,shapeBkg_bkg_bin2__norm=26270,shapeBkg_bkg_bin3__norm=6810 --setParameterRanges shapeBkg_bkg_bin1__norm=24000,25800:shapeBkg_bkg_bin2__norm=25200,27200:shapeBkg_bkg_bin3__norm=6400,7200"
  ### mc worked  --cminDefaultMinimizerStrategy 0 --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --robustFit 1  --setParameterRanges shapeBkg_bkg_bin1__norm=24000,26000:shapeBkg_bkg_bin2__norm=24000,28000:shapeBkg_bkg_bin3__norm=6000,7500 -t -1
   combineTool.py -M Impacts -d param_datacard_${NAME}.root -m 91 $FROZENPARAM -n .impacts_${NAME} --rMin -10 --rMax 10  --doInitialFit $EXTRA_OPT 
   combineTool.py -M Impacts -d param_datacard_${NAME}.root -m 91 $FROZENPARAM -n .impacts_${NAME} --rMin -10 --rMax 10 --doFits $EXTRA_OPT
   combineTool.py -M Impacts -d param_datacard_${NAME}.root -m 91 $FROZENPARAM -n .impacts_${NAME} --rMin -10 --rMax 10 -o impacts_${NAME}.json $EXTRA_OPT
   plotImpacts.py -i impacts_${NAME}.json -o ${NAME}_impacts --summary --blind
