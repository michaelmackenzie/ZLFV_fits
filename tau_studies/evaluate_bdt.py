...
if __name__ == "__main__":
  ...
  #load correct vars
  columns_keep = ['pt_ll', 'eta_ll', 'phi_ll', 'mass_ll', 'mcol', 'pt_l1', 'eta_l1', 'phi_l1', 'mass_l1',
                  'pt_l2', 'eta_l2', 'phi_l2', 'mass_l2', 'ratio_ptl2_ptl1',
  ...
  nentries = evaluate_bdt(bdt,args.measureFile,bdt_vars(),columns_keep,selection,"forMeas_"+args.extraName)
