...
if  [[ "${PROCESS}" == "impacts" ]]
then
   EXTRA_OPT=" --cminDefaultMinimizerStrategy 0 --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --robustFit 1 --X-rtd MINIMIZER_multiMin_maskChannels=2"
   ...
   # --rMin -10 --rMax 10
   combineTool.py -M Impacts -d param_datacard_${NAME}.root -m 91 $FROZENPARAM -n .impacts_${NAME} --rMin -1 --rMax 1  --doInitialFit $EXTRA_OPT 
   combineTool.py -M Impacts -d param_datacard_${NAME}.root -m 91 $FROZENPARAM -n .impacts_${NAME} --rMin -1 --rMax 1 --doFits $EXTRA_OPT --parallel 10
   combineTool.py -M Impacts -d param_datacard_${NAME}.root -m 91 $FROZENPARAM -n .impacts_${NAME} --rMin -1 --rMax 1 -o impacts_${NAME}.json $EXTRA_OPT
